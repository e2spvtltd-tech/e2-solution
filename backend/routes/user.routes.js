...
const { getDashboard, getProfile, updateProfile, requestWithdrawal, getReferrals, getNetwork, getNotifications, markNotificationsRead, updatePlacement } = require('../controllers/user.controller');
