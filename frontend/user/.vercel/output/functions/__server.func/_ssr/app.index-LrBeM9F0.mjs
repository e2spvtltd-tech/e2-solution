...
import { T as TrendingUp, d as WalletMinimal, G as Gift, R as Repeat, c as Users, e as ArrowUpRight, P as Plus } from "../_libs/lucide-react.mjs";
...
function Dashboard() {
  ...
  if (loading) return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 text-center", children: "Loading dashboard..." });
