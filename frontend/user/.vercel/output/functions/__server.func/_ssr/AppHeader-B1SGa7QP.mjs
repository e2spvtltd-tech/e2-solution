...
import { p as Search, X, m as Bell, y as Info, z as Menu, H as House, N as Network, J as Receipt, K as BadgeDollarSign, W as Wallet, U as User, o as LogOut } from "../_libs/lucide-react.mjs";
const links = [
