...
const ArrowDownLeft = createLucideIcon("arrow-down-left", __iconNode$K);
const __iconNode$J = [
...
const Headset = createLucideIcon("headset", __iconNode$s);
const __iconNode$r = [
...
const WalletMinimal = createLucideIcon("wallet-minimal", __iconNode$2);
const __iconNode$1 = [
  [
    "path",
    {
