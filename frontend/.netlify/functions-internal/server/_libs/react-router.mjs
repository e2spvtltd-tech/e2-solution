import { a as requireReact, c as commonjsGlobal } from "./react.mjs";
...
var chunkU7ORXROY = {};
var hasRequiredChunkU7ORXROY;
function requireChunkU7ORXROY() {
  if (hasRequiredChunkU7ORXROY) return chunkU7ORXROY;
  hasRequiredChunkU7ORXROY = 1;
  Object.defineProperty(chunkU7ORXROY, "__esModule", { value: true });
...
import(${JSON.stringify(manifest.entry.module)});`;
  ...
  chunkU7ORXROY.ABSOLUTE_URL_REGEX = ABSOLUTE_URL_REGEX;
  chunkU7ORXROY.PROTOCOL_RELATIVE_URL_REGEX = PROTOCOL_RELATIVE_URL_REGEX;
  chunkU7ORXROY.Action = Action;
  chunkU7ORXROY.createMemoryHistory = createMemoryHistory;
  chunkU7ORXROY.createBrowserHistory = createBrowserHistory;
  chunkU7ORXROY.createHashHistory = createHashHistory;
  chunkU7ORXROY.invariant = invariant;
  chunkU7ORXROY.warning = warning;
  chunkU7ORXROY.createPath = createPath;
  chunkU7ORXROY.parsePath = parsePath;
  chunkU7ORXROY.createContext = createContext;
  chunkU7ORXROY.RouterContextProvider = RouterContextProvider;
  chunkU7ORXROY.convertRoutesToDataRoutes = convertRoutesToDataRoutes;
  chunkU7ORXROY.matchRoutes = matchRoutes;
  chunkU7ORXROY.matchRoutesImpl = matchRoutesImpl;
  chunkU7ORXROY.generatePath = generatePath;
  chunkU7ORXROY.matchPath = matchPath;
  chunkU7ORXROY.stripBasename = stripBasename;
  chunkU7ORXROY.resolvePath = resolvePath;
  chunkU7ORXROY.resolveTo = resolveTo;
  chunkU7ORXROY.joinPaths = joinPaths;
  chunkU7ORXROY.data = data;
  chunkU7ORXROY.redirect = redirect;
  chunkU7ORXROY.redirectDocument = redirectDocument;
  chunkU7ORXROY.replace = replace;
  chunkU7ORXROY.SUPPORTED_ERROR_TYPES = SUPPORTED_ERROR_TYPES;
  chunkU7ORXROY.ErrorResponseImpl = ErrorResponseImpl;
  chunkU7ORXROY.isRouteErrorResponse = isRouteErrorResponse;
  chunkU7ORXROY.parseToInfo = parseToInfo;
  chunkU7ORXROY.escapeHtml = escapeHtml;
  chunkU7ORXROY.encode = encode;
  chunkU7ORXROY.instrumentHandler = instrumentHandler;
  chunkU7ORXROY.IDLE_NAVIGATION = IDLE_NAVIGATION;
  chunkU7ORXROY.IDLE_FETCHER = IDLE_FETCHER;
  chunkU7ORXROY.IDLE_BLOCKER = IDLE_BLOCKER;
  chunkU7ORXROY.createRouter = createRouter;
  chunkU7ORXROY.createStaticHandler = createStaticHandler;
  chunkU7ORXROY.getStaticContextFromError = getStaticContextFromError;
  chunkU7ORXROY.hasInvalidProtocol = hasInvalidProtocol;
  chunkU7ORXROY.isDataWithResponseInit = isDataWithResponseInit;
  chunkU7ORXROY.isResponse = isResponse;
  chunkU7ORXROY.isRedirectStatusCode = isRedirectStatusCode;
  chunkU7ORXROY.isRedirectResponse = isRedirectResponse;
  chunkU7ORXROY.isMutationMethod = isMutationMethod;
  chunkU7ORXROY.createRequestInit = createRequestInit;
  chunkU7ORXROY.SingleFetchRedirectSymbol = SingleFetchRedirectSymbol;
  chunkU7ORXROY.SINGLE_FETCH_REDIRECT_STATUS = SINGLE_FETCH_REDIRECT_STATUS;
  chunkU7ORXROY.NO_BODY_STATUS_CODES = NO_BODY_STATUS_CODES;
  chunkU7ORXROY.StreamTransfer = StreamTransfer;
  chunkU7ORXROY.getTurboStreamSingleFetchDataStrategy = getTurboStreamSingleFetchDataStrategy;
  chunkU7ORXROY.getSingleFetchDataStrategyImpl = getSingleFetchDataStrategyImpl;
  chunkU7ORXROY.stripIndexParam = stripIndexParam;
  chunkU7ORXROY.singleFetchUrl = singleFetchUrl;
  chunkU7ORXROY.decodeViaTurboStream = decodeViaTurboStream;
  chunkU7ORXROY.DataRouterContext = DataRouterContext;
  chunkU7ORXROY.DataRouterStateContext = DataRouterStateContext;
  chunkU7ORXROY.RSCRouterContext = RSCRouterContext;
  chunkU7ORXROY.ViewTransitionContext = ViewTransitionContext;
  chunkU7ORXROY.FetchersContext = FetchersContext;
  chunkU7ORXROY.AwaitContextProvider = AwaitContextProvider;
  chunkU7ORXROY.NavigationContext = NavigationContext;
  chunkU7ORXROY.LocationContext = LocationContext;
  chunkU7ORXROY.RouteContext = RouteContext;
  chunkU7ORXROY.ENABLE_DEV_WARNINGS = ENABLE_DEV_WARNINGS;
  chunkU7ORXROY.warnOnce = warnOnce;
  chunkU7ORXROY.decodeRedirectErrorDigest = decodeRedirectErrorDigest;
  chunkU7ORXROY.decodeRouteErrorResponseDigest = decodeRouteErrorResponseDigest;
  chunkU7ORXROY.useHref = useHref;
  chunkU7ORXROY.useInRouterContext = useInRouterContext;
  chunkU7ORXROY.useLocation = useLocation;
  chunkU7ORXROY.useNavigationType = useNavigationType;
  chunkU7ORXROY.useMatch = useMatch;
  chunkU7ORXROY.useNavigate = useNavigate;
  chunkU7ORXROY.useOutletContext = useOutletContext;
  chunkU7ORXROY.useOutlet = useOutlet;
  chunkU7ORXROY.useParams = useParams;
  chunkU7ORXROY.useResolvedPath = useResolvedPath;
  chunkU7ORXROY.useRoutes = useRoutes;
  chunkU7ORXROY.useRouteId = useRouteId;
  chunkU7ORXROY.useNavigation = useNavigation;
  chunkU7ORXROY.useRevalidator = useRevalidator;
  chunkU7ORXROY.useMatches = useMatches;
  chunkU7ORXROY.useLoaderData = useLoaderData;
  chunkU7ORXROY.useRouteLoaderData = useRouteLoaderData;
  chunkU7ORXROY.useActionData = useActionData;
  chunkU7ORXROY.useRouteError = useRouteError;
  chunkU7ORXROY.useAsyncValue = useAsyncValue;
  chunkU7ORXROY.useAsyncError = useAsyncError;
  chunkU7ORXROY.useBlocker = useBlocker;
  chunkU7ORXROY.useRoute = useRoute;
  chunkU7ORXROY.useRouterState = useRouterState;
  chunkU7ORXROY.RemixErrorBoundary = RemixErrorBoundary;
  chunkU7ORXROY.createServerRoutes = createServerRoutes;
  chunkU7ORXROY.createClientRoutesWithHMRRevalidationOptOut = createClientRoutesWithHMRRevalidationOptOut;
  chunkU7ORXROY.noActionDefinedError = noActionDefinedError;
  chunkU7ORXROY.createClientRoutes = createClientRoutes;
  chunkU7ORXROY.shouldHydrateRouteLoader = shouldHydrateRouteLoader;
  chunkU7ORXROY.URL_LIMIT = URL_LIMIT;
  chunkU7ORXROY.getPathsWithAncestors = getPathsWithAncestors;
  chunkU7ORXROY.getPatchRoutesOnNavigationFunction = getPatchRoutesOnNavigationFunction;
  chunkU7ORXROY.useFogOFWarDiscovery = useFogOFWarDiscovery;
  chunkU7ORXROY.getManifestPath = getManifestPath;
  chunkU7ORXROY.FrameworkContext = FrameworkContext;
  chunkU7ORXROY.usePrefetchBehavior = usePrefetchBehavior;
  chunkU7ORXROY.CRITICAL_CSS_DATA_ATTRIBUTE = CRITICAL_CSS_DATA_ATTRIBUTE;
  chunkU7ORXROY.Links = Links;
  chunkU7ORXROY.PrefetchPageLinks = PrefetchPageLinks;
  chunkU7ORXROY.Meta = Meta;
  chunkU7ORXROY.setIsHydrated = setIsHydrated;
  chunkU7ORXROY.Scripts = Scripts;
  chunkU7ORXROY.mergeRefs = mergeRefs;
  chunkU7ORXROY.mapRouteProperties = mapRouteProperties;
  chunkU7ORXROY.hydrationRouteProperties = hydrationRouteProperties;
  chunkU7ORXROY.createMemoryRouter = createMemoryRouter;
  chunkU7ORXROY.RouterProvider = RouterProvider;
  chunkU7ORXROY.DataRoutes = DataRoutes2;
  chunkU7ORXROY.MemoryRouter = MemoryRouter;
  chunkU7ORXROY.Navigate = Navigate;
  chunkU7ORXROY.Outlet = Outlet;
  chunkU7ORXROY.Route = Route;
  chunkU7ORXROY.Router = Router;
  chunkU7ORXROY.Routes = Routes;
  chunkU7ORXROY.Await = Await;
  chunkU7ORXROY.createRoutesFromChildren = createRoutesFromChildren;
  chunkU7ORXROY.createRoutesFromElements = createRoutesFromElements;
  chunkU7ORXROY.renderMatches = renderMatches;
  chunkU7ORXROY.WithComponentProps = WithComponentProps;
  chunkU7ORXROY.withComponentProps = withComponentProps;
  chunkU7ORXROY.WithHydrateFallbackProps = WithHydrateFallbackProps;
  chunkU7ORXROY.withHydrateFallbackProps = withHydrateFallbackProps;
  chunkU7ORXROY.WithErrorBoundaryProps = WithErrorBoundaryProps;
  chunkU7ORXROY.withErrorBoundaryProps = withErrorBoundaryProps;
  return chunkU7ORXROY;
}
var hasRequiredChunkWW7PN6QI;
function requireChunkWW7PN6QI() {
  if (hasRequiredChunkWW7PN6QI) return chunkWW7PN6QI;
  hasRequiredChunkWW7PN6QI = 1;
  Object.defineProperty(chunkWW7PN6QI, "__esModule", { value: true });
  function _interopRequireDefault(obj) {
    return obj && obj.__esModule ? obj : { default: obj };
  }
  var _chunkU7ORXROYjs = /* @__PURE__ */ requireChunkU7ORXROY();
  function getHydrationData({
    ...
    let initialMatches = _chunkU7ORXROYjs.matchRoutes.call(void 0, routes, location2, basename);
    if (initialMatches) {
      for (let match of initialMatches) {
        let routeId = match.route.id;
        let routeInfo = getRouteInfo(routeId);
        if (_chunkU7ORXROYjs.shouldHydrateRouteLoader.call(
          void 0,
          routeId,
  ...
  chunkWW7PN6QI.getHydrationData = getHydrationData;
  chunkWW7PN6QI.RSCRouterGlobalErrorBoundary = RSCRouterGlobalErrorBoundary;
  chunkWW7PN6QI.RSCDefaultRootErrorBoundary = RSCDefaultRootErrorBoundary;
  chunkWW7PN6QI.createRSCRouteModules = createRSCRouteModules;
  chunkWW7PN6QI.populateRSCRouteModules = populateRSCRouteModules;
  return chunkWW7PN6QI;
}
var development = {};
var chunkYL5M26XI = {};
var hasRequiredChunkYL5M26XI;
function requireChunkYL5M26XI() {
  if (hasRequiredChunkYL5M26XI) return chunkYL5M26XI;
  hasRequiredChunkYL5M26XI = 1;
  Object.defineProperty(chunkYL5M26XI, "__esModule", { value: true });
  function _interopRequireWildcard(obj) {
    if (obj && obj.__esModule) {
      return obj;
    } else {
  ...
  function deserializeErrors(errors) {
    ...
    for (let [key, val] of entries) {
      if (val && val.__type === "RouteErrorResponse") {
        serialized[key] = new _chunkU7ORXROYjs.ErrorResponseImpl(
          val.status,
          val.statusText,
          val.data,
          val.internal === true
  ...
  var Link = React.forwardRef(
    function LinkWithRef({
      ...
      let location2 = _chunkU7ORXROYjs.useLocation.call(void 0);
      let maskedHref = null;
      if (mask) {
        let resolved = _chunkU7ORXROYjs.resolveTo.call(
          void 0,
          mask,
          [],
      ...
      let [shouldPrefetch, prefetchRef, prefetchHandlers] = _chunkU7ORXROYjs.usePrefetchBehavior.call(
        void 0,
        prefetch,
        rest
      );
  ...
  function ScrollRestoration({
    ...
    return /* @__PURE__ */ React.createElement(
      "script",
      {
        ...
        suppressHydrationWarning: true,
        dangerouslySetInnerHTML: {
          __html: `(${restoreScroll})(${_chunkU7ORXROYjs.escapeHtml.call(
            void 0,
    ...
    return React.useCallback(
      (event) => {
        if (shouldProcessLinkClick(event, target)) {
          event.preventDefault();
          let replace = replaceProp !== void 0 ? replaceProp : _chunkU7ORXROYjs.createPath.call(void 0, location2) === _chunkU7ORXROYjs.createPath.call(void 0, path);
  ...
  function useFetcher({
    ...
    _chunkU7ORXROYjs.invariant.call(
      void 0,
      routeId != null,
    ...
    if (getKey) {
      if (basename !== "/") {
        key = getKey(
          {
            ...location2,
            pathname: _chunkU7ORXROYjs.stripBasename.call(void 0, location2.pathname, basename) || location2.pathname
          },
          matches
        );
      } else {
  ...
  function createStaticRouter(routes, context, opts = {}) {
    let manifest = {};
    let dataRoutes = _chunkU7ORXROYjs.convertRoutesToDataRoutes.call(
      void 0,
      routes,
  ...
  chunkYL5M26XI.createSearchParams = createSearchParams;
  chunkYL5M26XI.createBrowserRouter = createBrowserRouter;
  chunkYL5M26XI.createHashRouter = createHashRouter;
  chunkYL5M26XI.BrowserRouter = BrowserRouter;
  chunkYL5M26XI.HashRouter = HashRouter;
  chunkYL5M26XI.HistoryRouter = HistoryRouter;
  chunkYL5M26XI.Link = Link;
  chunkYL5M26XI.NavLink = NavLink;
  chunkYL5M26XI.Form = Form;
  chunkYL5M26XI.ScrollRestoration = ScrollRestoration;
  chunkYL5M26XI.useLinkClickHandler = useLinkClickHandler;
  chunkYL5M26XI.useSearchParams = useSearchParams;
  chunkYL5M26XI.useSubmit = useSubmit;
  chunkYL5M26XI.useFormAction = useFormAction;
  chunkYL5M26XI.useFetcher = useFetcher;
  chunkYL5M26XI.useFetchers = useFetchers;
  chunkYL5M26XI.useScrollRestoration = useScrollRestoration;
  chunkYL5M26XI.useBeforeUnload = useBeforeUnload;
  chunkYL5M26XI.usePrompt = usePrompt;
  chunkYL5M26XI.useViewTransitionState = useViewTransitionState;
  chunkYL5M26XI.StaticRouter = StaticRouter;
  chunkYL5M26XI.StaticRouterProvider = StaticRouterProvider;
  chunkYL5M26XI.createStaticHandler = createStaticHandler2;
  chunkYL5M26XI.createStaticRouter = createStaticRouter;
  return chunkYL5M26XI;
}
...
function requireDevelopment() {
  ...
  var _chunkWW7PN6QIjs = /* @__PURE__ */ requireChunkWW7PN6QI();
  var _chunkYL5M26XIjs = /* @__PURE__ */ requireChunkYL5M26XI();
  var _chunkU7ORXROYjs = /* @__PURE__ */ requireChunkU7ORXROY();
  var _react = requireReact();
  var React = _interopRequireWildcard(_react);
  var React2 = _interopRequireWildcard(_react);
  ...
  function ServerRouter({
    ...
    let routes = _chunkU7ORXROYjs.createServerRoutes.call(
      void 0,
      manifest.routes,
      routeModules,
      context.future,
    ...
    for (let match of context.staticHandlerContext.matches) {
      ...
      if (route && manifestRoute && _chunkU7ORXROYjs.shouldHydrateRouteLoader.call(
        void 0,
        routeId,
        route.clientLoader,
    ...
    return function RoutesTestStub({
      ...
      if (routerRef.current == null) {
        ...
        let patched = processRoutes(
          ...
          _context !== void 0 ? _context : _optionalChain([future, "optionalAccess", (_5) => _5.v8_middleware]) ? new _chunkU7ORXROYjs.RouterContextProvider() : {},
  ...
  function warnOnceAboutExpiresCookie(name, expires) {
    _chunkU7ORXROYjs.warnOnce.call(
      void 0,
      !expires,
  ...
  function matchServerRoutes(manifest, dataRoutes, branches, pathname, basename) {
    let matches = _chunkU7ORXROYjs.matchRoutesImpl.call(
      void 0,
      dataRoutes,
      pathname,
      _nullishCoalesce(basename, () => "/"),
      ...
      let commonRoute = {
        ...
        loader: route.module.loader ? async (args) => {
          ...
          if (preRenderedData != null) {
            ...
            let decoded = await _chunkU7ORXROYjs.decodeViaTurboStream.call(void 0, stream, commonjsGlobal);
  ...
  function derive(build, mode) {
    ...
    let requestHandler = async (request, initialContext) => {
      ...
      if (!build.ssr) {
        ...
        if (build.basename && build.basename !== "/") {
          ...
          if (strippedPath == null) {
            errorHandler(
              new _chunkU7ORXROYjs.ErrorResponseImpl(
                404,
                "Not Found",
      ...
      let manifestUrl = _chunkU7ORXROYjs.getManifestPath.call(
        void 0,
    ...
    if (build.entry.module.instrumentations) {
      requestHandler = _chunkU7ORXROYjs.instrumentHandler.call(
        void 0,
        requestHandler,
  ...
  async function handleDocumentRequest(serverMode, build, staticHandler, request, loadContext, handleError, isSpaMode, criticalCss) {
    ...
    async function renderHtml(context, isSpaMode2) {
      ...
      try {
        ...
        context = _chunkU7ORXROYjs.getStaticContextFromError.call(
          void 0,
          staticHandler.dataRoutes,
          context,
...
${String(error)}`;
          ...
          },
          {
            onError(error2) {
              if (typeof error2 === "object" && error2 && "digest" in error2 && typeof error2.digest === "string") {
                ...
                let routeErrorResponse = _chunkU7ORXROYjs.decodeRouteErrorResponseDigest.call(
                  void 0,
                  error2.digest
                );
                if (routeErrorResponse) {
  ...
  function RSCStaticRouter({ getPayload }) {
    ...
    const router = _chunkYL5M26XIjs.createStaticRouter.call(
      void 0,
  ...
  development.Await = _chunkU7ORXROYjs.Await;
  development.BrowserRouter = _chunkYL5M26XIjs.BrowserRouter;
  development.Form = _chunkYL5M26XIjs.Form;
  development.HashRouter = _chunkYL5M26XIjs.HashRouter;
  development.IDLE_BLOCKER = _chunkU7ORXROYjs.IDLE_BLOCKER;
  development.IDLE_FETCHER = _chunkU7ORXROYjs.IDLE_FETCHER;
  development.IDLE_NAVIGATION = _chunkU7ORXROYjs.IDLE_NAVIGATION;
  development.Link = _chunkYL5M26XIjs.Link;
  development.Links = _chunkU7ORXROYjs.Links;
  development.MemoryRouter = _chunkU7ORXROYjs.MemoryRouter;
  development.Meta = _chunkU7ORXROYjs.Meta;
  development.NavLink = _chunkYL5M26XIjs.NavLink;
  development.Navigate = _chunkU7ORXROYjs.Navigate;
  development.NavigationType = _chunkU7ORXROYjs.Action;
  development.Outlet = _chunkU7ORXROYjs.Outlet;
  development.PrefetchPageLinks = _chunkU7ORXROYjs.PrefetchPageLinks;
  development.Route = _chunkU7ORXROYjs.Route;
  development.Router = _chunkU7ORXROYjs.Router;
  development.RouterContextProvider = _chunkU7ORXROYjs.RouterContextProvider;
  development.RouterProvider = _chunkU7ORXROYjs.RouterProvider;
  development.Routes = _chunkU7ORXROYjs.Routes;
  development.Scripts = _chunkU7ORXROYjs.Scripts;
  development.ScrollRestoration = _chunkYL5M26XIjs.ScrollRestoration;
  development.ServerRouter = ServerRouter;
  development.StaticRouter = _chunkYL5M26XIjs.StaticRouter;
  development.StaticRouterProvider = _chunkYL5M26XIjs.StaticRouterProvider;
  development.UNSAFE_AwaitContextProvider = _chunkU7ORXROYjs.AwaitContextProvider;
  development.UNSAFE_DataRouterContext = _chunkU7ORXROYjs.DataRouterContext;
  development.UNSAFE_DataRouterStateContext = _chunkU7ORXROYjs.DataRouterStateContext;
  development.UNSAFE_ErrorResponseImpl = _chunkU7ORXROYjs.ErrorResponseImpl;
  development.UNSAFE_FetchersContext = _chunkU7ORXROYjs.FetchersContext;
  development.UNSAFE_FrameworkContext = _chunkU7ORXROYjs.FrameworkContext;
  development.UNSAFE_LocationContext = _chunkU7ORXROYjs.LocationContext;
  development.UNSAFE_NavigationContext = _chunkU7ORXROYjs.NavigationContext;
  development.UNSAFE_RSCDefaultRootErrorBoundary = _chunkWW7PN6QIjs.RSCDefaultRootErrorBoundary;
  development.UNSAFE_RemixErrorBoundary = _chunkU7ORXROYjs.RemixErrorBoundary;
  development.UNSAFE_RouteContext = _chunkU7ORXROYjs.RouteContext;
  development.UNSAFE_ServerMode = ServerMode;
  development.UNSAFE_SingleFetchRedirectSymbol = _chunkU7ORXROYjs.SingleFetchRedirectSymbol;
  development.UNSAFE_ViewTransitionContext = _chunkU7ORXROYjs.ViewTransitionContext;
  development.UNSAFE_WithComponentProps = _chunkU7ORXROYjs.WithComponentProps;
  development.UNSAFE_WithErrorBoundaryProps = _chunkU7ORXROYjs.WithErrorBoundaryProps;
  development.UNSAFE_WithHydrateFallbackProps = _chunkU7ORXROYjs.WithHydrateFallbackProps;
  development.UNSAFE_createBrowserHistory = _chunkU7ORXROYjs.createBrowserHistory;
  development.UNSAFE_createClientRoutes = _chunkU7ORXROYjs.createClientRoutes;
  development.UNSAFE_createClientRoutesWithHMRRevalidationOptOut = _chunkU7ORXROYjs.createClientRoutesWithHMRRevalidationOptOut;
  development.UNSAFE_createHashHistory = _chunkU7ORXROYjs.createHashHistory;
  development.UNSAFE_createMemoryHistory = _chunkU7ORXROYjs.createMemoryHistory;
  development.UNSAFE_createRouter = _chunkU7ORXROYjs.createRouter;
  development.UNSAFE_decodeViaTurboStream = _chunkU7ORXROYjs.decodeViaTurboStream;
  development.UNSAFE_getHydrationData = _chunkWW7PN6QIjs.getHydrationData;
  development.UNSAFE_getPatchRoutesOnNavigationFunction = _chunkU7ORXROYjs.getPatchRoutesOnNavigationFunction;
  development.UNSAFE_getTurboStreamSingleFetchDataStrategy = _chunkU7ORXROYjs.getTurboStreamSingleFetchDataStrategy;
  development.UNSAFE_hydrationRouteProperties = _chunkU7ORXROYjs.hydrationRouteProperties;
  development.UNSAFE_invariant = _chunkU7ORXROYjs.invariant;
  development.UNSAFE_mapRouteProperties = _chunkU7ORXROYjs.mapRouteProperties;
  development.UNSAFE_shouldHydrateRouteLoader = _chunkU7ORXROYjs.shouldHydrateRouteLoader;
  development.UNSAFE_useFogOFWarDiscovery = _chunkU7ORXROYjs.useFogOFWarDiscovery;
  development.UNSAFE_useScrollRestoration = _chunkYL5M26XIjs.useScrollRestoration;
  development.UNSAFE_withComponentProps = _chunkU7ORXROYjs.withComponentProps;
  development.UNSAFE_withErrorBoundaryProps = _chunkU7ORXROYjs.withErrorBoundaryProps;
  development.UNSAFE_withHydrateFallbackProps = _chunkU7ORXROYjs.withHydrateFallbackProps;
  development.createBrowserRouter = _chunkYL5M26XIjs.createBrowserRouter;
  development.createContext = _chunkU7ORXROYjs.createContext;
  development.createCookie = createCookie;
  development.createCookieSessionStorage = createCookieSessionStorage;
  development.createHashRouter = _chunkYL5M26XIjs.createHashRouter;
  development.createMemoryRouter = _chunkU7ORXROYjs.createMemoryRouter;
  development.createMemorySessionStorage = createMemorySessionStorage;
  development.createPath = _chunkU7ORXROYjs.createPath;
  development.createRequestHandler = createRequestHandler;
  development.createRoutesFromChildren = _chunkU7ORXROYjs.createRoutesFromChildren;
  development.createRoutesFromElements = _chunkU7ORXROYjs.createRoutesFromElements;
  development.createRoutesStub = createRoutesStub;
  development.createSearchParams = _chunkYL5M26XIjs.createSearchParams;
  development.createSession = createSession;
  development.createSessionStorage = createSessionStorage;
  development.createStaticHandler = _chunkYL5M26XIjs.createStaticHandler;
  development.createStaticRouter = _chunkYL5M26XIjs.createStaticRouter;
  development.data = _chunkU7ORXROYjs.data;
  development.generatePath = _chunkU7ORXROYjs.generatePath;
  development.href = href;
  development.isCookie = isCookie;
  development.isRouteErrorResponse = _chunkU7ORXROYjs.isRouteErrorResponse;
  development.isSession = isSession;
  development.matchPath = _chunkU7ORXROYjs.matchPath;
  development.matchRoutes = _chunkU7ORXROYjs.matchRoutes;
  development.parsePath = _chunkU7ORXROYjs.parsePath;
  development.redirect = _chunkU7ORXROYjs.redirect;
  development.redirectDocument = _chunkU7ORXROYjs.redirectDocument;
  development.renderMatches = _chunkU7ORXROYjs.renderMatches;
  development.replace = _chunkU7ORXROYjs.replace;
  development.resolvePath = _chunkU7ORXROYjs.resolvePath;
  development.unstable_HistoryRouter = _chunkYL5M26XIjs.HistoryRouter;
  ...
  development.unstable_usePrompt = _chunkYL5M26XIjs.usePrompt;
  development.unstable_useRoute = _chunkU7ORXROYjs.useRoute;
  development.unstable_useRouterState = _chunkU7ORXROYjs.useRouterState;
  development.useActionData = _chunkU7ORXROYjs.useActionData;
  development.useAsyncError = _chunkU7ORXROYjs.useAsyncError;
  development.useAsyncValue = _chunkU7ORXROYjs.useAsyncValue;
  development.useBeforeUnload = _chunkYL5M26XIjs.useBeforeUnload;
  development.useBlocker = _chunkU7ORXROYjs.useBlocker;
  development.useFetcher = _chunkYL5M26XIjs.useFetcher;
  development.useFetchers = _chunkYL5M26XIjs.useFetchers;
  development.useFormAction = _chunkYL5M26XIjs.useFormAction;
  development.useHref = _chunkU7ORXROYjs.useHref;
  development.useInRouterContext = _chunkU7ORXROYjs.useInRouterContext;
  development.useLinkClickHandler = _chunkYL5M26XIjs.useLinkClickHandler;
  development.useLoaderData = _chunkU7ORXROYjs.useLoaderData;
  development.useLocation = _chunkU7ORXROYjs.useLocation;
  development.useMatch = _chunkU7ORXROYjs.useMatch;
  development.useMatches = _chunkU7ORXROYjs.useMatches;
  development.useNavigate = _chunkU7ORXROYjs.useNavigate;
  development.useNavigation = _chunkU7ORXROYjs.useNavigation;
  development.useNavigationType = _chunkU7ORXROYjs.useNavigationType;
  development.useOutlet = _chunkU7ORXROYjs.useOutlet;
  development.useOutletContext = _chunkU7ORXROYjs.useOutletContext;
  development.useParams = _chunkU7ORXROYjs.useParams;
  development.useResolvedPath = _chunkU7ORXROYjs.useResolvedPath;
  development.useRevalidator = _chunkU7ORXROYjs.useRevalidator;
  development.useRouteError = _chunkU7ORXROYjs.useRouteError;
  development.useRouteLoaderData = _chunkU7ORXROYjs.useRouteLoaderData;
  development.useRoutes = _chunkU7ORXROYjs.useRoutes;
  development.useSearchParams = _chunkYL5M26XIjs.useSearchParams;
  development.useSubmit = _chunkYL5M26XIjs.useSubmit;
  development.useViewTransitionState = _chunkYL5M26XIjs.useViewTransitionState;
  return development;
}
...
function requireDomExport() {
  ...
  function getRSCSingleFetchDataStrategy(getRouter, ssr, basename, createFromReadableStream, fetchImplementation) {
    let dataStrategy = _chunkU7ORXROYjs.getSingleFetchDataStrategyImpl.call(
      void 0,
      getRouter,
      (match) => {
        let M = match;
  ...
  function getFetchAndDecodeViaRSC(createFromReadableStream, fetchImplementation) {
    return async (args, basename, trailingSlashAware, targetRoutes) => {
      ...
      if (res.status >= 400 && !res.headers.has("X-Remix-Response")) {
        throw new _chunkU7ORXROYjs.ErrorResponseImpl(res.status, res.statusText, await res.text());
      }
  ...
  function createRouteFromServerManifest(match, payload) {
    ...
    if (typeof dataRoute.loader === "function") {
      dataRoute.loader.hydrate = _chunkU7ORXROYjs.shouldHydrateRouteLoader.call(
        void 0,
        match.id,
        match.clientLoader,
        match.hasLoader,
...
export {
  requireDevelopment as a,
  requireDomExport as r
};
