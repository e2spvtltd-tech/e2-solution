...
import { T as TrendingUp, y as CalendarDays, z as Calendar, f as WalletMinimal } from "../_libs/lucide-react.mjs";
...
function EarningsPage() {
  ...
  const renderKPIs = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "grid grid-cols-2 gap-3 md:gap-4 md:grid-cols-4 mt-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { icon: TrendingUp, label: "Today's Earnings", value: inr(0), tone: "success" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { icon: CalendarDays, label: "Weekly Earnings", value: inr(0), tone: "primary" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { icon: Calendar, label: "Monthly Earnings", value: inr(0), tone: "warning" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { icon: WalletMinimal, label: "Total Earnings", value: inr(0), tone: "default" })
  ] });
