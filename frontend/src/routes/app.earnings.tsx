...
function EarningsPage() {
  ...
  const renderKPIs = () => (
    <section className="grid grid-cols-2 gap-3 md:gap-4 md:grid-cols-4 mt-6">
      <StatCard icon={TrendingUp} label="Today's Earnings" value={inr(0)} tone="success" />
      <StatCard icon={CalendarDays} label="Weekly Earnings" value={inr(0)} tone="primary" />
      <StatCard icon={Calendar} label="Monthly Earnings" value={inr(0)} tone="warning" />
      <StatCard icon={Wallet2} label="Total Earnings" value={inr(0)} tone="default" />
    </section>
  );
